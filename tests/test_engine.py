...
def test_search_by_symptom():
    ...
    engine.data = [
        {"sintoma_canonico": "ACNÉ", "zonas_detectadas": ["piel"], "interpretaciones": []},
        {"sintoma_canonico": "GASTRITIS", "zonas_detectadas": ["estómago"], "interpretaciones": []}
    ]
...
def test_search_by_zone():
    engine = SearchEngine.__new__(SearchEngine)
    engine.data = [
        {"sintoma_canonico": "ACNÉ", "zonas_detectadas": ["piel", "cara"], "interpretaciones": []},
        {"sintoma_canonico": "GASTRITIS", "zonas_detectadas": ["estómago"], "interpretaciones": []}
    ]
...
def test_multi_vector_search():
    ...
    engine.data = [
        {"sintoma_canonico": "ACNÉ", "zonas_detectadas": ["piel", "cara"], "interpretaciones": []},
        {"sintoma_canonico": "ACNÉ", "zonas_detectadas": ["piel", "cuello"], "interpretaciones": []},
        {"sintoma_canonico": "GASTRITIS", "zonas_detectadas": ["estómago"], "interpretaciones": []}
    ]
